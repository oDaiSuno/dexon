...
test("legacy JSONL session tools use the latest valid state for sidecar migration", () => {
  const entries = [
    { type: "custom", customType: "dexon-session-tools", data: { version: 1, toolNames: ["read"] } },
    { type: "custom", customType: "other", data: { version: 1, toolNames: ["bash"] } },
    { type: "custom", customType: "dexon-session-tools", data: { version: 2, toolNames: ["write"] } },
    {
      type: "custom",
      customType: "dexon-session-tools",
